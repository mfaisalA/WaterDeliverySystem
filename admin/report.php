<?php require_once 'includes/header.php'; ?>
      ...
      <div class="clearfix"></div>
	  	...
	  	<br>
            <div class="panel-body">
                <div class="col-sm-6">
                 <form class="form-horizontal" action="print_report.php" method="post" id="getReportForm">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                      <button type="submit" class="btn btn-info" id="printReportBtn"> Generate Report</button>
                    </div>
                  </div>
                </form>
            </div>
    ...
    //             var mywindow = window.open('', 'Judicial Procedure System', 'height=400,width=600');
    //     mywindow.document.write('<html><head><title>Cases Report</title>');        
