	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
		...
		<div class="panel panel-info">
	  	<div class="panel-heading">
	  		<a href="add_service.php" class="btn btn-success pull-right" style="margin: 10px"><span class="glyphicon glyphicon-plus"> Add Type</span></a>
	  		<h3><span class="glyphicon glyphicon-cog"></span> Types List</h3>
					...
					while ($row = mysqli_fetch_assoc($rs)){?>
		  			...
		  			<tr>
						...
						<ul class="list-inline">
							<li>
								<a href="edit_service.php?edit_id=<?=$row['id'] ?>" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
							</li>
							<li>
